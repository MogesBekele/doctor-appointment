  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 border p-8 py-7 border-gray-400 rounded-lg bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
      ...
      <button className="bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-9">Book an appointment</button>
      </div>
